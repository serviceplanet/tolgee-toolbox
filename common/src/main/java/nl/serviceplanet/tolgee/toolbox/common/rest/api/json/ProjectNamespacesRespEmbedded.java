...
public final class ProjectNamespacesRespEmbedded {
	
	private List<ProjectNamespace> namespaces = ImmutableList.of();

	public List<ProjectNamespace> getNamespaces() {
		return namespaces;
	}

	public void setNamespaces(List<ProjectNamespace> namespaces) {
